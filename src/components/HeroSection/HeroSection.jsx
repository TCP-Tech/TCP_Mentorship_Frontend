  ...
  return (
    ...
    <div className='flex flex-col card bg-white dark:bg-gray-900 lg:flex-row sm:p-8'>
        <div className="lg:w-1/2 leftSection flex flex-col justify-center">
            ...
            <p className="text-xl md:text-2xl text-left text-zinc-700 dark:text-white font-sans antialiased mt-10 md:ml-10 m-0 sm:mr-10 lg:mr-0 text-center md:text-left">Empower Your Coding Journey with Expert Mentorship</p>
            <p className="text-xl md:text-2xl text-left text-zinc-700 dark:text-white font-sans antialiased mt-5 md:ml-10 m-0 sm:mr-10 lg:mr-0 text-center md:text-left">Elevate your skills in competitive programming, data structures and algorithms, and software development with our personalized mentorship program.</p>
        </div>
