...
const AddProblem = () => {
  ...
  return (
    <div className="flex flex-col  space-x-8">
     <h1 className="text-3xl text-black pt-7 pb-5 ml-8 font-semibold">Add a Problem</h1>
       <form>
  ...
  />
            ...
            <div className="col-span-full">
              ...
              <p className="mt-3 text-sm leading-6 text-gray-600">Write a few sentences about the problem. (optional)</p>
            </div>
            <div className="sm:col-span-4">
