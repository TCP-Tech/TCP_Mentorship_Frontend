...
const MenteeSideBar = ({ toggleSidebar }) => {
    ...
    <div className="flex flex-col border text-left h-screen md:relative absolute md:w-fit w-screen bg-white text-black">
      ...
      <div className="px-3 pt-8">
        <ul className="text-lg space-y-5 pt-2 font-semibold">
          <li className="hover:bg-primary hover:text-white rounded-md px-5 py-2 cursor-pointer transition duration-300 ease-in-out">
            Dashboard
          </li>
          <li className="hover:bg-primary hover:text-white rounded-md px-5 py-2 cursor-pointer transition duration-300 ease-in-out">
            LeaderBoard
