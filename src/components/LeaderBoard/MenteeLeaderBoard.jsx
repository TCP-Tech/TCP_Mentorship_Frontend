...
const MenteeLeaderBoard = () => {
  ...
  return (
    ...
    <div className="flex items-center text-center justify-center gap-x-3 mt-20">
        <h2 className="md:text-5xl text-3xl font-bold font-custom text-gray-800 dark:text-black mb-16">Mentee LeaderBoard</h2>
    </div>
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 table-fixed">
                        <thead className="bg-gray-50 dark:bg-black">
                            <tr>
                                ...
                                <th scope="col" className="px-4 py-3.5 text-sm md:text-xl font-normal text-left rtl:text-right text-gray-500 dark:text-white ">Team</th>

                                <th scope="col" className="px-4 py-3.5 text-sm md:text-xl font-normal  rtl:text-right text-gray-500 dark:text-white ">Achievements</th>
                            </tr>
                        </thead>
                        {
                            mentees.map((mentee)=>(
                                ...
                                <tr>
                                    <td className="px-5 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                        <div className="inline-flex items-center gap-x-3  md:text-lg text-white">
                                            ...
                                            <div className="flex items-center gap-x-2">
                                                ...
                                                <div>
                                                    <h2 className="font-medium text-gray-800 dark:text-white ">{mentee.name}</h2>
                                                    <p className="text-sm font-normal text-gray-600 dark:text-gray-400">@{mentee.name}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-20 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                        <div className="inline-flex items-center text-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                            ...
                                            <h2 className="text-sm md:text-lg font-normal text-emerald-500 ">{mentee.problemsSolved}</h2>
                                        </div>
                                    </td>
                                    <td className="px-9 py-4 text-sm md:text-lg text-gray-500 dark:text-gray-300 whitespace-nowrap">{mentee.pointsScored}</td>
                                    <td className="px-4 py-4 text-sm md:text-lg text-gray-500 dark:text-gray-300 whitespace-nowrap">{mentee.teamName}</td>
