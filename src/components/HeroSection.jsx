...
const HeroSection = () => {
  return (
      <div className="flex lg:justify-center lg:items-center my-16">
        <div className="flex flex-col card bg-white dark:bg-gray-900 lg:flex-row">
          <div className="lg:w-[60%] flex flex-col justify-start">
            ...
            <h1 className="text-5xl md:text-7xl text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-[var(--primary-c)] dark:from-blue-100 dark:to-blue-500 font-bold mt-8 mr-0 sm:mr-10 lg:mr-0 text-center md:text-left">
              MENTORSHIP
            </h1>
            <h1 className="text-5xl md:text-7xl text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-[var(--primary-c)] dark:from-blue-100 dark:to-blue-500 font-bold mr-0 sm:mr-10 lg:mr-0 pb-4 text-center md:text-left">
              PROGRAM 2024
            </h1>
            <p className="text-lg md:text-xl text-zinc-700 dark:text-white mt-10 m-0 sm:mr-10 lg:mr-0 font-bold">
            ...
            <p className="text-lg md:text-xl text-zinc-700 dark:text-white mt-5 m-0 sm:mr-10 lg:mr-0">
              ...
              and algorithms, and software development with our personalized
              mentorship program.
            </p>
          </div>
