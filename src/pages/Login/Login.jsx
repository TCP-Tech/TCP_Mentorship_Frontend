      ...
      <div className="h-screen w-full bg-white flex-col md:flex-row shadow-lg flex">
        ...
        <div className=" text-center">
          <button
            ...
            onClick={Menteelogin}
          >
            <img src={Menteeimg} alt="" className="sm:h-36 sm:w-36 h-28 w-28 rounded-full" />
          ...
          <button
            ...
            onClick={mentorlogin}
          >
            <img src={Mentorimg} alt="" className="sm:h-36 sm:w-36 h-28 w-28 rounded-full" />
          ...
          <div className=" mt-10 text-xs gap-4 flex justify-between items-center text-[var(--primary-c)]">
            ...
            {usertype==="Mentee"?<div className="flex flex-row items-center gap-2">
