...
const Team = () => {
  ...
  return (
    <div className="text-black w-screen h-full flex flex-col items-center text-center dark:bg-gray-800 py-12">
        <div className="flex justify-center items-center py-12  gap-2">
          ...
          <Link to="/">
            <div
            className="bg-primary flex space-x-2 text-black md:ml-10 text-lg px-10 py-4 dark:text-white dark:bg-transparent dark:border dark:hover:bg-primary dark:hover:border-primary dark:hover:text-black transition-all duration-300 rounded-lg">
          ...
          <div className="text-5xl font-bold dark:text-white py-10">Overall Coordinators</div>
        ...
        <div className="text-5xl font-bold dark:text-white py-10">Head Coordinators</div>
        <div className="flex flex-wrap justify-center gap-4">
        ...
        <div className="text-5xl font-bold dark:text-white py-10">Managers</div>
        <div className="flex flex-wrap justify-center gap-4">
        ...
        <div className="text-5xl font-bold dark:text-white py-10">Executives</div>
        <div className="flex flex-wrap justify-center gap-4">
